...
public class testihannari {
    ...
    public static void main(String[] args) {
        System.out.println("Welcome To The Hki adventure!"); // Printing The Heading
...
public static void startGame() {
        ...
        System.out.println("Goto Angervotie 10 28m2 asunto: ");
        System.out.println("1. Vähäpukeinen noinen");
